...
export default function Page() {
    ...
    return (
        <Suspense fallback={fallbackContent}>
            <QuizPageContent session={session} router={router} />
        </Suspense>
    );
}

interface QuizPageContentProps {
    session: Session | null; // Assuming session could be null or a Session object
    router: any;
}

function QuizPageContent({ session, router }: QuizPageContentProps) {
